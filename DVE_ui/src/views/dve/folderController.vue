<template>
    ...
    <el-table-column fixed="right" label="操作" width="300" header-align="center">
        <template v-slot="scope">
          <el-button
            link
            type="primary"
            @click="deleteFolderMethod(scope.row.uid,scope.row.agentId,scope.row.type,scope.row.parentId)"
            size="small"
            >删除</el-button
          >
          <el-button
          ...
          <el-button
            link
            type="primary"
            @click="getFileInfoMethod(scope.row.uid,scope.row.agentId,scope.row.parentId,scope.row.type)"
            size="small"
            >权限管理 </el-button
          >
          <!-- <el-button
    ...
    <el-form :model="createFolderBody" label-width="80px" style="max-width: 600px">
      ...
      <el-form-item>
        <el-button @click="createFolderMethod">在当前目录下创建新文件夹</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-form :model="folderVisibleBody" label-width="80px" style="max-width: 600px">
      ...
      <el-form-item>
        <el-button @click="setFolderVisibleMethod">设置该组可见该文件夹</el-button>
        <el-button @click="setFolderInvisibleMethod">设置该组不可见该文件夹</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table-column label="哈希" prop="hash" width="180">
    </el-table-column>
    </el-table>
    <span style="display: block; text-align: center;font-size: 16px; line-height: 3;">分组与权限信息</span>
    <el-table 
    :data="userGroupData" 
    style="width: 100%" 
    ...
    <span style="display: block; text-align: center;font-size: 16px; line-height: 3;">该文件拥有的权限</span>
    <el-table 
      ...
      ><el-table-column label="组别" prop="groupId" width="180">
      </el-table-column>
      <el-table-column label="拥有权限" prop="allowedMethod" width="180">
      </el-table-column>
    </el-table>
    <span style="display: block; text-align: center;font-size: 16px; line-height: 3;">更新文件权限</span>
    <el-form :model="setFileRuleBody" label-width="80px" style="max-width: 600px">
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button type="primary" @click="closeFileInfo">
            确认
          </el-button>
        </span>
      </template>
